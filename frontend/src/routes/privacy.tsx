    ...
    <AppShell variant="light">
      <article className="mx-auto max-w-3xl px-4 py-16 md:px-8">
        ...
        <div className="prose mt-8 max-w-none text-[color:var(--color-ink)]">
          <p>
            En NexoLeal recolectamos solo los datos necesarios para operar tu programa de lealtad:
            nombre del negocio, contacto del dueño, y datos básicos de tus clientes para identificar
          ...
          <p>
            Para operar el servicio, generar campañas con IA y mostrar métricas a los dueños de
            negocio.
          </p>
