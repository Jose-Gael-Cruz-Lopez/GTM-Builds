    ...
    <AppShell variant="dark" showNav={false}>
      ...
      <main className="mx-auto max-w-md px-4 py-6">
        ...
        {loading ? (
          ...
          <form
            onSubmit={save}
            className="mt-6 space-y-4 rounded-2xl bg-[var(--color-bg-elevated)] p-5"
          >
            <div>
              <Label htmlFor="name" className="text-[color:var(--color-cream)]/80">
                Nombre completo
              </Label>
              <Input
                id="name"
                ...
                className="bg-[var(--color-bg-base)] text-[color:var(--color-cream)]"
              />
            </div>
            <div>
              <Label htmlFor="email" className="text-[color:var(--color-cream)]/80">
                Email
              </Label>
              <Input
                id="email"
                value={email}
                disabled
                className="bg-[var(--color-bg-base)] text-[color:var(--color-cream)]/60"
              />
            </div>
        ...
        <div className="mt-10 rounded-2xl border border-[color:var(--color-status-risk)]/30 bg-[var(--color-bg-elevated)] p-5">
          ...
          <p className="mt-1 text-xs text-[color:var(--color-cream)]/60">
            Cerrar sesión te llevará al inicio. Tus cartas seguirán guardadas.
          </p>
          <Button
            variant="outline"
            onClick={async () => {
