    ...
    <AppShell variant="light">
      <article className="mx-auto max-w-3xl px-4 py-16 md:px-8">
        ...
        <div className="prose mt-8 max-w-none text-[color:var(--color-ink)]">
          <p>
            NexoLeal es una plataforma para que pequeñas y medianas empresas administren programas
            de lealtad digital. Al usar el servicio, aceptas estos términos.
          </p>
          <h2 className="mt-8 font-display text-xl">1. Uso del servicio</h2>
          <p>
            El servicio se proporciona "tal cual" durante el periodo MVP. Nos reservamos el derecho
            de actualizar funciones, precios y disponibilidad.
          </p>
          <h2 className="mt-8 font-display text-xl">2. Datos y privacidad</h2>
          <p>
            Consulta nuestra política de privacidad para conocer cómo manejamos los datos de tu
