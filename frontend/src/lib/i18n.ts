...
export type Dictionary = {
  ...
  landing: {
    ...
    footerRights: string;
    footerGroups: {
      product: { heading: string; features: string; pricing: string; demo: string; changes: string };
...
const es: Dictionary = {
  ...
  signup: {
    ...
    awaitBodyPost: 'y haz clic en el botón de confirmación. Cuando regreses, tu negocio se creará automáticamente.',
    errorCreate: 'No pudimos crear tu cuenta',
    errorRateLimit: 'No podemos enviar el correo de confirmación ahora mismo (límite del proveedor). Espera unos minutos e inténtalo otra vez.',
  ...
  landing: {
    ...
    aboutParagraph1: 'Construimos NexoLeal para los negocios que recuerdan el nombre de cada cliente.',
    aboutParagraph2: 'La fidelidad no se compra con descuentos: se gana con atención.',
    aboutParagraph3: 'Cada flujo, cada mensaje y cada recompensa fue diseñado para que volver sea la opción más natural.',
    scrollStackAriaLabel: 'Casos de uso de NexoLeal',
    panelEyebrow: 'Hecho para volver',
    download: 'Descargar',
    recentAddingsAriaLabel: 'Lo nuevo en NexoLeal',
    colors: 'Colores',
    explore: 'Explorar',
    footerMadeIn: 'Hecho en México · 2026',
    footerRights: '© 2026 NexoLeal. Todos los derechos reservados.',
    footerGroups: {
      product: { heading: 'Producto', features: 'Características', pricing: 'Precios', demo: 'Demo', changes: 'Cambios' },
      company: { heading: 'Empresa', about: 'Sobre', diary: 'Diario', contact: 'Contacto', work: 'Trabaja con nosotros' },
  ...
  scan: {
    ...
    staffKeyDescription: 'Se guarda solo en este dispositivo (IndexedDB). Pégala tal como te la entregó el dueño del negocio.',
    ...
    cameraDescription: 'Activa la cámara para escanear los códigos QR de tus clientes en el mostrador.',
  ...
  wallet: {
    ...
    demoDescription: 'En tu cuenta real, este QR se renueva cada 90 segundos y solo se puede escanear una vez.',
  ...
  dashboard: {
    ...
    noDataDescription: 'Comparte tu QR con tus clientes y empezarás a ver visitas y métricas aquí en cuanto registren su primer escaneo.',
    ...
    unavailableDescription: 'Estamos terminando esta vista. Mientras tanto, ve los datos resumidos en el panel principal.',
    ...
    noVisitsDescription: 'Cuando tu staff escanee códigos QR, las visitas aparecerán aquí al instante.',
    visitTable: {
      date: 'Fecha',
      client: 'Cliente',
      stamps: 'Sellos',
    ...
    noRewardsDescription: 'Cuando un cliente complete sus sellos, la recompensa aparecerá aquí para que la entregues en caja.',
    ...
    weeklyInsightDefault: 'Comparte tu enlace con clientes para descubrir patrones de visita esta semana.',
    ...
    analyticsEmptyDescription: 'Comparte tu enlace con clientes y vuelve pronto para ver tendencias y patrones.',
    vsYesterday: 'vs ayer',
  },
  campaigns: {
    title: 'Campañas',
    ...
    emptyDescription: 'Elige un segmento, define tu objetivo y deja que la IA redacte mensajes listos para enviar por WhatsApp.',
    ...
    audienceEmpty: 'No hay clientes en este segmento todavía. Puedes activar la campaña y enviarla cuando tengas audiencia.',
    audienceCancel: 'Cancelar',
    audienceConfirm: 'Confirmar',
    audienceActivating: 'Activando...',
    markSentTitle: '¿Enviaste la campaña?',
    markSentDescription: 'Si ya compartiste el mensaje por WhatsApp, márcala como enviada para llevar el control de tus campañas.',
    ...
    generationDescription: 'Hola — vamos a crear mensajes que reconecten con tus clientes. Paso {step} de 3.',
    step1Question: '¿A quién quieres llegar? Elige un segmento ilustrado o describe uno personalizado.',
  ...
  settings: {
    ...
    dangerZone: 'Zona de peligro',
    dangerDescription: 'Pausar oculta tu negocio de nuevos clientes. Eliminar desactiva el programa de forma permanente.',
    pauseBusiness: 'Pausar negocio',
    deleteBusiness: 'Eliminar negocio',
    pauseTitle: '¿Pausar tu negocio?',
    pauseDescription: 'Los clientes existentes conservan sus sellos, pero no podrás registrar nuevas visitas hasta reactivarlo.',
    pauseConfirm: 'Pausar',
    deleteStep1Title: '¿Eliminar este negocio?',
    deleteStep1Description: 'Esta acción desactiva tu programa de lealtad. Tus clientes ya no podrán acumular sellos.',
    ...
    accountSessionsDescription: 'Cierra sesión en todos los dispositivos donde iniciaste con esta cuenta.',
    signOutAll: 'Cerrar sesión en todos lados',
    deleteAccountTitle: 'Eliminar cuenta',
    deleteAccountDescription: 'Esta acción cierra tu sesión y pausa tus negocios. Es irreversible desde la app.',
    deleteAccountBtn: 'Eliminar mi cuenta',
    deleteAccountDialogTitle: '¿Eliminar tu cuenta?',
    deleteAccountDialogDescription: 'Escribe ELIMINAR para confirmar. Perderás acceso al panel de propietario.',
  ...
  onboarding: {
    ...
    welcomeBodyNamed: 'Vamos a dejar listo tu programa de lealtad para tu {type} en 3 pasos rápidos.',
    stepBrand: 'Marca',
    ...
    rewardDescription: 'Define cuántas visitas necesita un cliente para ganar y la recompensa que recibirá.',
    ...
    finishDescription: 'Comparte, imprime y configura tu equipo para empezar a sumar clientes frecuentes.',
  ...
  legal: {
    ...
    privacyIntro: 'En NexoLeal recolectamos solo los datos necesarios para operar tu programa de lealtad: nombre del negocio, contacto del dueño, y datos básicos de tus clientes para identificar visitas y recompensas.',
    ...
    privacySection2Body: 'Para operar el servicio, generar campañas con IA y mostrar métricas a los dueños de negocio.',
    privacySection3: '3. Tus derechos',
    privacySection3Body: 'Puedes solicitar eliminar tu cuenta en cualquier momento desde Configuración.',
    termsIntro: 'NexoLeal es una plataforma para que pequeñas y medianas empresas administren programas de lealtad digital. Al usar el servicio, aceptas estos términos.',
    termsSection1: '1. Uso del servicio',
    termsSection1Body: 'El servicio se proporciona "tal cual" durante el periodo MVP. Nos reservamos el derecho de actualizar funciones, precios y disponibilidad.',
    termsSection2: '2. Datos y privacidad',
    termsSection2Body: 'Consulta nuestra política de privacidad para conocer cómo manejamos los datos de tu negocio y tus clientes.',
...
const en: Dictionary = {
  ...
  signup: {
    ...
    awaitBodyPost: 'and click the confirmation button. When you return, your business will be created automatically.',
    errorCreate: 'Could not create your account',
    errorRateLimit: "We can't send the confirmation email right now (provider rate limit). Wait a few minutes and try again.",
  ...
  landing: {
    ...
    aboutParagraph3: 'Every flow, every message and every reward was designed to make returning the most natural choice.',
    scrollStackAriaLabel: 'NexoLeal use cases',
    panelEyebrow: 'Built to bring them back',
    download: 'Download',
    recentAddingsAriaLabel: "What's new in NexoLeal",
    colors: 'Colors',
    explore: 'Explore',
    footerMadeIn: 'Made in Mexico · 2026',
    footerRights: '© 2026 NexoLeal. All rights reserved.',
    footerGroups: {
      product: { heading: 'Product', features: 'Features', pricing: 'Pricing', demo: 'Demo', changes: 'Changelog' },
      company: { heading: 'Company', about: 'About', diary: 'Journal', contact: 'Contact', work: 'Work with us' },
  ...
  scan: {
    ...
    staffKeyDescription: 'Stored only on this device (IndexedDB). Paste it exactly as provided by the business owner.',
  ...
  wallet: {
    ...
    demoDescription: 'In your real account, this QR renews every 90 seconds and can only be scanned once.',
  ...
  dashboard: {
    ...
    healthy: 'Healthy',
    noData: 'No data yet',
    noDataDescription: 'Share your QR with customers and you will start seeing visits and metrics here as soon as they register their first scan.',
    ...
    unavailableDescription: 'We are finishing this view. In the meantime, see the summary data on the main panel.',
    ...
    noRewardsDescription: 'When a customer completes their stamps, the reward will appear here for you to deliver at the counter.',
    ...
    analyticsEmptyDescription: 'Share your link with customers and come back soon to see trends and patterns.',
  ...
  campaigns: {
    ...
    emptyDescription: 'Choose a segment, set your objective and let AI draft messages ready to send via WhatsApp.',
    ...
    audienceEmpty: 'No clients in this segment yet. You can activate the campaign and send it when you have an audience.',
    audienceCancel: 'Cancel',
    audienceConfirm: 'Confirm',
    audienceActivating: 'Activating...',
    markSentTitle: 'Did you send the campaign?',
    markSentDescription: 'If you already shared the message via WhatsApp, mark it as sent to keep track of your campaigns.',
    markSentNo: 'Not yet',
    markSentConfirm: 'Mark as sent',
    markSentSaving: 'Saving...',
    statsLoading: 'Loading metrics...',
    statsPreparation: 'Metrics in preparation',
    statsPreparationDetail: 'Soon you will be able to see opens, clicks and conversions for this campaign.',
    statsSent: 'Sent',
    statsOpenRate: 'Open rate',
    statsRedemptions: 'Redemptions',
    generationTitle: 'Generate with AI',
    generationDescription: 'Hi — let\'s create messages that reconnect with your customers. Step {step} of 3.',
    step1Question: 'Who do you want to reach? Choose an illustrated segment or describe a custom one.',
  ...
  settings: {
    ...
    dangerZone: 'Danger zone',
    dangerDescription: 'Pausing hides your business from new customers. Deleting permanently deactivates the program.',
    pauseBusiness: 'Pause business',
    deleteBusiness: 'Delete business',
    pauseTitle: 'Pause your business?',
    pauseDescription: 'Existing customers keep their stamps, but you will not be able to register new visits until you reactivate.',
    pauseConfirm: 'Pause',
    deleteStep1Title: 'Delete this business?',
    deleteStep1Description: 'This action deactivates your loyalty program. Your customers will no longer be able to accumulate stamps.',
    ...
    deleteAccountDescription: 'This action signs you out and pauses your businesses. It is irreversible from the app.',
    deleteAccountBtn: 'Delete my account',
    deleteAccountDialogTitle: 'Delete your account?',
    deleteAccountDialogDescription: 'Type DELETE to confirm. You will lose access to the owner panel.',
  ...
  onboarding: {
    ...
    brandDescription: 'Upload your logo and choose the colors your customers will see when scanning the QR.',
    logoLabel: 'Logo',
    ...
    rewardDescription: 'Define how many visits a customer needs to earn and what reward they will receive.',
    ...
    finishDescription: 'Share, print and set up your team to start accumulating frequent customers.',
  ...
  legal: {
    ...
    privacyIntro: 'At NexoLeal we collect only the data necessary to operate your loyalty program: business name, owner contact, and basic customer data to identify visits and rewards.',
    ...
    privacySection2Body: 'To operate the service, generate AI campaigns and display metrics to business owners.',
    privacySection3: '3. Your rights',
    privacySection3Body: 'You can request account deletion at any time from Settings.',
    termsIntro: 'NexoLeal is a platform for small and medium businesses to manage digital loyalty programs. By using the service, you agree to these terms.',
    termsSection1: '1. Use of service',
    termsSection1Body: 'The service is provided "as is" during the MVP period. We reserve the right to update features, pricing and availability.',
    termsSection2: '2. Data and privacy',
    termsSection2Body: 'See our privacy policy to learn how we handle your business and customer data.',
