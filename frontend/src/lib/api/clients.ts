...
import type { BusinessCategory, ClientStatus, Tables } from "@/integrations/supabase/types";
...
export const clientsApi = {
  ...
  getMe: () => apiFetch<{ client: ClientProfile }>("/clients/me"),
  getLoyalty: (businessId: string) =>
    apiFetch<LoyaltyForBusinessResponse>(`/clients/me/loyalty/${businessId}`),
  listLoyaltyCards: () => apiFetch<{ cards: LoyaltyCard[] }>("/clients/me/loyalty"),
};
