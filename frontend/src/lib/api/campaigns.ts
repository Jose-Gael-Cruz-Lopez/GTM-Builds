...
import type { CampaignStatus, CampaignTargetSegment, Tables } from "@/integrations/supabase/types";
...
export const campaignsApi = {
  ...
  get: (businessId: string, campaignId: string) =>
    apiFetch<{ campaign: Campaign }>(`/businesses/${businessId}/campaigns/${campaignId}`),
  activate: (businessId: string, campaignId: string) =>
    apiFetch<{ campaign: Campaign }>(`/businesses/${businessId}/campaigns/${campaignId}/activate`, {
      method: "POST",
    }),
